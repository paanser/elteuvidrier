...
amplada_m = st.number_input("Amplada (en metres)", min_value=0.0, step=0.001)
amplada = round(amplada_m * 100)
alcada_m = st.number_input("Alçada (en metres)", min_value=0.0, step=0.001)
alcada = round(alcada_m * 100)
